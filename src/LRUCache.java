...
public class LRUCache implements Cache {
    ...
    public void print() {
        System.out.println("LRUCache.print not implemented");
    }
    ...
    public static void main(String[] args) {
        ...
        cache.put(1); // Miss, Add 1. State: 1
        cache.put(2); // Miss, Add 2. State: 2 <-> 1
        cache.put(3); // Miss, Add 3. State: 3 <-> 2 <-> 1 (Full)
        cache.put(2); // Hit, Move 2. State: 2 <-> 3 <-> 1
        cache.put(4); // Miss, Evict 1, Add 4. State: 4 <-> 2 <-> 3
        cache.put(1); // Miss, Evict 3, Add 1. State: 1 <-> 4 <-> 2
        cache.put(2); // Hit, Move 2. State: 2 <-> 1 <-> 4
        cache.put(5); // Miss, Evict 4, Add 5. State: 5 <-> 2 <-> 1
        cache.put(1); // Hit, Move 1. State: 1 <-> 5 <-> 2
        cache.put(2); // Hit, Move 2. State: 2 <-> 1 <-> 5
        cache.put(3); // Miss, Evict 5, Add 3. State: 3 <-> 2 <-> 1
        cache.put(4); // Miss, Evict 1, Add 4. State: 4 <-> 3 <-> 2
        cache.put(5); // Miss, Evict 2, Add 5. State: 5 <-> 4 <-> 3
